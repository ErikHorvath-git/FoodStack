                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Column(children: [
                          SizedBox(
                            ...
                            child: TabBar(
                              ...
                              isScrollable : true,
                              dividerHeight: 0.2,
                              dividerColor: Theme.of(context).hintColor.withValues(alpha: 0.5),
                              tabs: tabList,
                              onTap: (int ? value) {
                                setState(() {
                          ...
                          CustomTextFieldWidget(
                            hintText: "${'title'.tr} (${_languageList![multiLanguageTabController!.index].value})".tr,
                          ...
                          CustomTextFieldWidget(
                            hintText: "${'description'.tr} ${_languageList[multiLanguageTabController!.index].value}".tr,
                  ...
                  Row(
                    children: [
                      ...
                      Text(' *', style: robotoMedium.copyWith(color: Colors.red)),
                    ],
                  ),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
