                                ...
                                child: Stack(clipBehavior: Clip.none, children: [
                                  ClipRRect(
                                    ...
                                    child: deliverymanController.pickedImage != null ? GetPlatform.isWeb ? Image.network(
                                      deliverymanController.pickedImage!.path, width: 120, height: 120, fit: BoxFit.cover,
                                    ) : Image.file(
                                      File(deliverymanController.pickedImage!.path), width: 120, height: 120, fit: BoxFit.cover,
                                    ) : Container(
